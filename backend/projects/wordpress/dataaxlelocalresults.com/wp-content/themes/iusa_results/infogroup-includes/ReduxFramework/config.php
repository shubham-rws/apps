    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'       => 'emergency-banner',
                'type'     => 'textarea',
                'title'    => 'Sitewide Emergency Banner', 
                'subtitle' => 'This is displayed at the very top of the site on every page. This should only be used for emergency scenarios such as app outages.',                
                'args'     => array(
                    'teeny'            => true,
                    'textarea_rows'    => 5,
                    'media_buttons'    => false,
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'desc'  => 'Apply <code>data-toggle="offCanvas"</code> to any element to make it open the Off Canvas on click. or if the attribute cannot be applied, add the class name of <code>offCanvasTrigger</code> and jQuery will apply the attribute.',
                'required' => array('off-canvas-yes-no','equals','1'),
            ),
        )
    ));
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'       => 'modal-on-mobile',
                'type'     => 'button_set',
                'title'    => 'Show modal on mobile devices?',
                'subtitle' => '',
                'desc'     => 'Choose either Yes or No.',                
                //Must provide key => value pairs for radio options
                'options'  => array(
