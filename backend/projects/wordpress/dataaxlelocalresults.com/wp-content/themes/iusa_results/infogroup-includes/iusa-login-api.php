...
function iusa_login_password_reset_field($form) {
    ...
    foreach($form['fields'] as &$field) {
      ...
      if ($field->id == 4) {
        ...
        $field->content = '<a href="https://' . $iusaAppEnvironmentDomain . '/Authentication/ForgotPassword?bas_vendor=190000">Forgot your password?</a>';
...
add_filter('gform_pre_render_3', 'iusa_login_password_reset_field');
...
add_action('gform_validation_6', 'iusa_login_user', 10, 2);
...
add_filter('gform_confirmation_6', 'iusa_login_confirmation', 10, 4);
...
add_filter('gform_validation_message_6', 'iusa_login_error_message', 10, 2);
