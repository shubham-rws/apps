...
?>   
    <footer id="site-footer" role="contentinfo">
    	...
    	<div id="footer-content" class="row small-up-1 medium-up-5 large-up-5 container1140">
          ...
          <p>Questions: <a class="bas_phone" href="tel:866.542.2555">866.542.2555</a></p>
  			</div>
      ...
      <div id="floating-contact-methods" class="show-for-large">
        ...
        <div id="floating-call">
          ...
          <p><span>Talk To A Marketing Expert Now</span><br>Call <a href="tel:800.835.5856" class="bas-phone">800.835.5856</a></p>
      ...
      <?php if ($infogroup_options['chat-phone-slide'] == '1') { ?>
        ...
        <div id="slide-up-contact-window">
          ...
          <a style="width:100%;" href="tel:866.612.2554" class="ig-button ig-button-solid ig-orange-button float-center bas-phone"><i class="fa fa-phone"></i> Call 866.612.2554</a>

          <a style="width:100%;" href="#" class="ig-button ig-button-solid ig-orange-button float-center iusa-live-chat"><i class="fa fa-comments"></i> Let's Chat</a>

          <a style="width:100%;" href="#" target="_self" class="ig-button ig-button-solid ig-orange-button float-center no-thanks-close">No Thanks</a>
    ...
    <div class="tiny reveal" id="footer-registration-modal" data-reveal>
      <?php echo do_shortcode('[gravityform id="1" title="false" description="false" ajax="true" single_full_name="true"]'); ?>
      <button class="close-button" data-close aria-label="Close reveal" type="button"><span aria-hidden="true">&times;</span></button>
    </div>
