...
function infogroup_modal() {
    ...
    if ($customPageModalOn == 'Yes') {
        ...
        if (!in_array($currentPage, $excludedPages)) {
           ...
           echo '<div id="areYouSure"><img src="' . THEMEDIRECTORYURI . '/img/bubbleTriangle.png" alt="Are you sure? Once you close this the offer is gone for good!" /><p>Are you sure you want to close this offer? It\'s gone for good if you do!</p></div>';
