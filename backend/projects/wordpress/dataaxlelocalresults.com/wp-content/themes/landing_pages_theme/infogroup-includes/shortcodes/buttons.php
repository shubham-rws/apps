...
function infogroup_button($atts) {
	...
	if ($buttonColor == 'grey') {
		$colorClass = 'ig-grey-button';
	} elseif ($buttonColor == 'blue') {
		$colorClass = 'ig-blue-button';
	...
	$igButton = '<a style="width:' . $a['width'] . ';" href="' . $a['link']['url'] . '" target="' . $a['target'] . '" class="' . $a['class'] . ' ig-button ' . ($a['style'] == 'solid' ? 'ig-button-solid ' : 'ig-button-outline ') . $colorClass . ' ' . $alignmentClass . '">' . $a['button_text'] . '</a>';
