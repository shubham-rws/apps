...
function register_navigation_menus() {
  register_nav_menus(
    array(
	  ...
	  'lp-main-menu' => __( 'The Main Landing Page Navigation Menu' ),
...
if ( ! function_exists('main_landing_page_navigation')) {
	function main_landing_page_navigation() {
		wp_nav_menu( array(
			'container'      => false,
			'menu'  		 => 'Main Landing Page Nav Menu',
