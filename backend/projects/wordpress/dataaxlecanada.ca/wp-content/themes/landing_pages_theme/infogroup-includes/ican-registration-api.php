...
add_action('gform_validation_7', 'iusa_register_or_login_user', 10, 2);

// french registration form
add_action('gform_validation_5', 'iusa_register_or_login_user', 10, 2);
...
// english registration form - modal
add_filter('gform_confirmation_7', 'iusa_registration_confirmation', 10, 4);

// french registration form
add_filter('gform_confirmation_5', 'iusa_registration_confirmation', 10, 4);
...
add_action('gform_validation_6', 'canadian_email_consent', 10, 2);
